...
public final class w {
    ...
    public static Method f484a;

    static {
        if (Build.VERSION.SDK_INT == 25) {
            try {
                f484a = ViewConfiguration.class.getDeclaredMethod("getScaledScrollFactor", new Class[0]);
            } catch (Exception e) {
    ...
    public static float a(ViewConfiguration config, Context context) {
        Method method;
        if (Build.VERSION.SDK_INT >= 25 && (method = f484a) != null) {
            try {
