...
public class d extends AutoCompleteTextView implements a.h.k.u {

    /* renamed from: b, reason: collision with root package name */
    public static final int[] f141b = {R.attr.popupBackground};
    public final e c;
    public final z d;
    ...
    public d(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        x0 a2 = x0.v(getContext(), attrs, f141b, defStyleAttr, 0);
        if (a2.s(0)) {
