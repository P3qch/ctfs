...
public class c1 {
    ...
    public void e(View anchorView, int anchorX, int anchorY, boolean fromTouch, CharSequence tooltipText) {
        ...
        WindowManager wm = (WindowManager) this.f139a.getSystemService("window");
        wm.addView(this.f140b, this.d);
    }
    ...
    public void c() {
        ...
        WindowManager wm = (WindowManager) this.f139a.getSystemService("window");
        wm.removeView(this.f140b);
    }

    public boolean d() {
        return this.f140b.getParent() != null;
    }
    ...
    public final void a(View anchorView, int anchorX, int anchorY, boolean fromTouch, WindowManager.LayoutParams outParams) {
        ...
        int tooltipPreciseAnchorThreshold = this.f139a.getResources().getDimensionPixelOffset(R.dimen.tooltip_precise_anchor_threshold);
        ...
        if (anchorView.getHeight() >= tooltipPreciseAnchorThreshold) {
            int offsetExtra2 = this.f139a.getResources().getDimensionPixelOffset(R.dimen.tooltip_precise_anchor_extra_offset);
        ...
        int tooltipOffset = this.f139a.getResources().getDimensionPixelOffset(fromTouch ? R.dimen.tooltip_y_offset_touch : R.dimen.tooltip_y_offset_non_touch);
        ...
        if (rect.left < 0 && rect.top < 0) {
            Resources res = this.f139a.getResources();
        ...
        this.f140b.measure(spec, spec);
        int tooltipHeight = this.f140b.getMeasuredHeight();
        int[] iArr3 = this.f;
