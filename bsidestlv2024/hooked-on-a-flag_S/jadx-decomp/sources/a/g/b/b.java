...
public class b {
    ...
    public static final ThreadLocal<Matrix> f335a = new ThreadLocal<>();

    /* renamed from: b, reason: collision with root package name */
    public static final ThreadLocal<RectF> f336b = new ThreadLocal<>();

    public static void c(ViewGroup parent, View descendant, Rect rect) {
        ThreadLocal<Matrix> threadLocal = f335a;
        ...
        ThreadLocal<RectF> threadLocal2 = f336b;
